...
\newcommand\Ans[1]{ 			%%hide for 
	% \textcolor{colorS}{\footnotesize #1}
}
\newcommand\note[1]{
...
\newcommand\blank[1]{\rule{2cm}{0.15mm}}
\newcommand\blankAbrev[1]{\\ \rule{\linewidth}{0.15mm}}
...
\newcommand*{\getanswer}[5]{%
	...
	{\begin{answer}\thequestion. {\LARGE $\bullet \circ \circ \,\circ$}\end{answer}}
	{\ifthenelse{\equal{#5}{b}}
		{\begin{answer}\thequestion. {\LARGE $\circ \bullet \circ \,\circ$} \end{answer}}
		{\ifthenelse{\equal{#5}{c}}
			{\begin{answer}\thequestion. {\LARGE $\circ \circ \bullet \,\circ$} \end{answer}}
			{\ifthenelse{\equal{#5}{d}}
				{\begin{answer}\thequestion. {\LARGE $\circ \circ \circ \, \bullet$} \end{answer}}
				{\begin{answer}\thequestion. {\LARGE $\circ \circ \circ \, \circ$} \end{answer}}}}}
}
...
\newcommand{\twoch}[5]{
	...
	\begin{tabular}{*{2}{@{}p{0.5\linewidth}}}
		(b)~#2 & (d)~#4
	\end{tabular}
	\vspace{-1em}					%Negative Vertical Spacing
	\getanswer{#1}{#2}{#3}{#4}{#5}  }
%(A)
%(B)
%(C)
...
\setlength\fourthtabwidth{0.15\linewidth}
\newlength\halftabwidth
\setlength\halftabwidth{0.3\linewidth}	%adjust for spacing before onech
%%
\newcommand{\choice}[5]{%
